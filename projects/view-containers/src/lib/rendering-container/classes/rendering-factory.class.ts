...
export class RenderingFactory{
    ...
    constructor(private container : RenderingContainer){

    }

    setAssets(assets: ContainerComponentAsset<ContainerNodeComponent>[]){
        this.assets = assets
    }

    asset(htmlTag: HtmlTag):ContainerComponentAsset<ContainerNodeComponent>|undefined{
